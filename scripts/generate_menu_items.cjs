...
// Detailed data mapping for all 24 items
const itemsConfig = [
  {
    id: 'prod-20',
    originalId: '20',
    ...
    ingredients: ['Lean Chicken', 'Herbal Broth Base (Angelica, Wolfberry, Licorice)', 'Shiitake Mushroom', 'Tofu Puffs', 'Organic Brown Rice', 'Bok Choy'],
    ingredientsZh: ['农场鲜嫩鸡肉', '天然本草汤底(当归、枸杞、甘草)', '精选香菇', '豆卜豆腐泡', '有机糙米', '清脆青梗菜'],
    allergens: ['Soy'],
    allergensZh: ['大豆'],
  ...
  },
  {
    ...
    ingredients: ['Norwegian Salmon', 'Grilled Chicken Breast', 'Organic Brown Rice', 'Steamed Broccoli', 'Sweet Corn', 'Japanese Edamame', 'Olive Oil'],
    ingredientsZh: ['挪威三文鱼排', '香烤鸡胸肉', '有机原粒糙米', '鲜西兰花', '甜玉米粒', '日式毛豆仁', '冷压橄榄油'],
    allergens: ['Fish', 'Soy'],
    allergensZh: ['鱼类', '大豆'],
  ...
  },
  {
    ...
    category: ['high-protein', 'under-500'],
    price: 15.90,
    calories: 470,
    protein: 44,
    carbs: 46,
    ...
    ingredients: ['Fresh Chicken Breast', 'Roasted Garlic', 'Organic Brown Rice', 'Steamed Broccoli', 'Carrots', 'Sea Salt', 'Extra Virgin Olive Oil'],
    ingredientsZh: ['农场鲜鸡胸肉', '焙香大蒜', '有机糙米', '清蒸西兰花', '胡萝卜', '天然海盐', '特级初榨橄榄油'],
  ...
  },
  {
    ...
    category: ['signature', 'high-protein', 'under-500'],
    price: 15.90,
    calories: 450,
    protein: 36,
    carbs: 42,
    ...
    ingredients: ['Wild Sea Prawns', 'Farm Eggs', 'Spring Onions', 'Organic Brown Rice', 'Steamed Vegetables', 'White Pepper'],
    ingredientsZh: ['野生海虾仁', '优质农场鸡蛋', '鲜葱花', '有机原粒糙米', '清蒸健康时蔬', '白胡椒'],
  ...
  },
  {
    ...
    ingredients: ['Chicken Breast', 'Sarawak Black Pepper', 'Organic Brown Rice', 'Broccoli', 'Cherry Tomatoes', 'Low-Sodium Soy Glaze'],
    ingredientsZh: ['鲜鸡胸肉', '砂拉越纯黑胡椒', '有机糙米', '鲜西兰花', '小番茄', '低钠秘制酱汁'],
    allergens: ['Soy'],
    allergensZh: ['大豆'],
  ...
  },
  {
    ...
    ingredients: ['Chicken Breast', 'Korean Gochujang', 'Sesame Oil', 'Organic Brown Rice', 'Sweet Corn', 'Carrots', 'Edamame'],
    ingredientsZh: ['鲜鸡胸肉', '韩式辣椒酱', '纯芝麻油', '有机糙米', '甜玉米粒', '胡萝卜', '毛豆仁'],
  ...
  },
  {
    ...
    ingredients: ['Grilled Korean Chicken', 'Mixed Salad Greens', 'Cherry Tomatoes', 'Japanese Cucumber', 'Toasted Sesame', 'Light Vinaigrette'],
    ingredientsZh: ['韩式烤鸡条', '综合新鲜生菜', '小番茄', '日本小黄瓜', '焙香芝麻', '特调轻沙拉汁'],
    allergens: ['Soy', 'Sesame'],
    allergensZh: ['大豆', '芝麻'],
  ...
  },
  {
    ...
    category: ['low-carb', 'under-500', 'high-protein'],
    price: 18.90,
    calories: 340,
    protein: 34,
    carbs: 16,
    ...
    ingredients: ['Grilled Sea Prawns', 'Romaine & Butterhead Lettuce', 'Purple Cabbage', 'Sweet Corn', 'Cherry Tomatoes', 'Lemon Olive Dressing'],
    ingredientsZh: ['鲜烤海大虾', '罗马及奶油生菜', '紫甘蓝', '甜玉米粒', '小番茄', '清新柠檬橄榄汁'],
  ...
  },
  {
    ...
    ingredients: ['Sea Prawns', 'Organic Brown Rice', 'Broccoli Florets', 'Carrots', 'Garlic Olive Glaze', 'Sea Salt'],
    ingredientsZh: ['优质鲜海虾', '有机糙米饭', '西兰花', '胡萝卜', '蒜香橄榄油', '天然海盐'],
    allergens: ['Crustacean'],
    allergensZh: ['甲壳类'],
  ...
  },
  {
    ...
    ingredients: ['Smoked Duck Breast', 'Mixed Crisp Greens', 'Cherry Tomatoes', 'Cucumbers', 'Edamame', 'Aged Balsamic Dressing'],
    ingredientsZh: ['精选烟熏鸭胸', '综合爽脆生菜', '多汁小番茄', '小黄瓜', '日式毛豆', '香醇意式油醋汁'],
  ...
  },
  {
    ...
    ingredients: ['Smoked Duck Slices', 'Organic Brown Rice', 'Steamed Broccoli', 'Carrots', 'Black Pepper', 'Natural Seasoning'],
    ingredientsZh: ['精选烟熏鸭胸肉片', '有机糙米', '清蒸西兰花', '胡萝卜', '现磨黑胡椒', '天然调味'],
  ...
  },
  {
    ...
    ingredients: ['Whole Wheat Pasta', 'Lean Minced Chicken', 'Simmered Tomato Sauce', 'Italian Herbs & Basil', 'Zucchini', 'Olive Oil'],
    ingredientsZh: ['全麦意面', '精瘦农场鸡胸肉碎', '慢熬番茄酱', '意式香草罗勒', '嫩西葫芦', '特级初榨橄榄油'],
    allergens: ['Gluten'],
    allergensZh: ['麸质'],
  ...
  },
  {
    ...
    ingredients: ['Chicken Thigh & Breast', 'Shiitake Mushrooms', 'Whole Garlic', 'Premium Dark Soy', 'Organic Brown Rice', 'Steamed Bok Choy'],
    ingredientsZh: ['去皮嫩鸡肉', '天然香菇', '整颗大蒜', '传统特级黑酱油', '有机糙米', '清脆青梗菜'],
    allergens: ['Soy'],
    allergensZh: ['大豆'],
  ...
  },
  {
    ...
    ingredients: ['Atlantic Salmon Fillet', 'Organic Brown Rice', 'Steamed Broccoli', 'Sweet Corn', 'Lemon Wedge', 'Sea Salt & Pepper'],
    ingredientsZh: ['大西洋三文鱼排', '有机原粒糙米', '清蒸西兰花', '甜玉米粒', '鲜柠檬角', '海盐黑胡椒'],
    allergens: ['Fish'],
    allergensZh: ['鱼类'],
  ...
  },
  {
    ...
    category: ['signature', 'low-carb', 'high-protein', 'under-500'],
    price: 18.90,
    calories: 380,
    protein: 36,
    carbs: 12,
    ...
    ingredients: ['Norwegian Salmon Fillet', 'Crisp Hydroponic Lettuce', 'Japanese Edamame', 'Cherry Tomatoes', 'Cucumbers', 'Lemon Herb Vinaigrette'],
    ingredientsZh: ['挪威三文鱼排', '水培鲜嫩生菜', '日式毛豆仁', '小番茄', '黄瓜片', '柠檬香草轻醋汁'],
    allergens: ['Fish', 'Soy'],
    allergensZh: ['鱼类', '大豆'],
  ...
  },
  {
    ...
    ingredients: ['Chicken Breast', 'Fresh Lemongrass', 'Galangal', 'Turmeric', 'Shallots', 'Organic Brown Rice', 'Steamed Vegetables'],
    ingredientsZh: ['农场鲜鸡胸', '新鲜香茅', '南姜', '野生天然姜黄', '红葱头', '有机糙米', '清蒸健康蔬菜'],
  ...
  },
  {
    ...
    ingredients: ['Minced Chicken Breast', 'Egg Whites', 'Diced Onions', 'Fresh Parsley', 'Organic Brown Rice', 'Steamed Vegetables'],
    ingredientsZh: ['精打鸡胸肉碎', '农场蛋白', '新鲜洋葱丁', '欧芹香草', '有机原粒糙米', '清蒸鲜蔬'],
    allergens: ['Egg'],
    allergensZh: ['蛋类'],
  ...
  },
  {
    ...
    ingredients: ['Grilled Chicken Breast', 'House Signature Sauce', 'Mixed Lettuce Greens', 'Cherry Tomatoes', 'Cucumbers', 'Carrot Slaw'],
    ingredientsZh: ['香烤鲜鸡胸肉片', '独家招牌低卡酱汁', '综合新鲜生菜', '小番茄', '黄瓜丁', '胡萝卜丝'],
    allergens: ['Soy'],
    allergensZh: ['大豆'],
  ...
  },
  {
    ...
    category: ['signature', 'low-carb', 'under-500', 'high-protein'],
    price: 15.90,
    calories: 330,
    protein: 35,
    carbs: 14,
    ...
    ingredients: ['100% Sea Prawn Paste', 'Garden Salad Mix', 'Purple Cabbage', 'Sweet Corn', 'Cherry Tomatoes', 'Light Sesame Shoyu Dressing'],
    ingredientsZh: ['100%纯海虾滑', '花园生菜综合包', '紫甘蓝', '甜玉米粒', '小番茄', '特调轻芝麻和风汁'],
    allergens: ['Crustacean', 'Sesame'],
    allergensZh: ['甲壳类', '芝麻'],
  ...
  },
  {
    ...
    ingredients: ['Buckwheat Soba Noodles', 'Signature Chicken Patty', 'Japanese Cucumber', 'Shredded Nori', 'Light Dashi Shoyu', 'White Sesame'],
    ingredientsZh: ['日式高纤荞麦面', '招牌手打鸡肉饼', '日本小黄瓜丝', '香脆海苔丝', '和风昆布清酱油', '焙煎白芝麻'],
    allergens: ['Gluten', 'Soy', 'Egg'],
    allergensZh: ['麸质', '大豆', '蛋类'],
  ...
  },
  {
    ...
    category: ['plant-based', 'under-500'],
    price: 15.90,
    calories: 440,
    protein: 26,
    carbs: 55,
    ...
    ingredients: ['Organic Soybean Tempeh', 'Organic Brown Rice', 'Steamed Broccoli', 'Sweet Corn', 'Carrots', 'Low-Sodium Soy Marinade'],
    ingredientsZh: ['有机发酵大豆天贝', '有机原粒糙米', '清蒸西兰花', '甜玉米粒', '胡萝卜', '低钠秘制豆酱'],
    allergens: ['Soy'],
    allergensZh: ['大豆'],
  ...
  },
  {
    ...
    category: ['plant-based', 'low-carb', 'under-500'],
    price: 15.90,
    calories: 320,
    protein: 24,
    carbs: 22,
    ...
    ingredients: ['Pan-Seared Organic Tempeh', 'Mixed Salad Greens', 'Japanese Edamame', 'Purple Cabbage', 'Cucumbers', 'Sesame Ginger Dressing'],
    ingredientsZh: ['香煎有机天贝丁', '综合新鲜生菜', '日式毛豆仁', '紫甘蓝', '爽脆黄瓜片', '芝麻姜汁轻沙拉汁'],
    allergens: ['Soy', 'Sesame'],
    allergensZh: ['大豆', '芝麻'],
  ...
  },
  {
    ...
    category: ['high-protein', 'signature'],
    price: 18.90,
    calories: 520,
    protein: 43,
    carbs: 54,
    ...
    ingredients: ['Minced Chicken Breast', 'Fresh Thai Holy Basil', 'Garlic & Mild Chili', 'Al Dente Pasta', 'Light Fish Sauce & Soy', 'Olive Oil'],
    ingredientsZh: ['精瘦鸡肉碎', '新鲜泰式打抛九层塔', '大蒜与鲜辣椒', '筋道意面', '特调低钠鱼露轻酱', '冷压橄榄油'],
    allergens: ['Gluten', 'Fish', 'Soy'],
    allergensZh: ['麸质', '鱼类', '大豆'],
  ...
  },
  {
    ...
    category: ['plant-based', 'under-500', 'low-carb'],
    price: 15.90,
    calories: 390,
    protein: 18,
    carbs: 52,
    ...
    ingredients: ['King Oyster Mushrooms', 'Shiitake Mushrooms', 'Shimeji Mushrooms', 'Organic Brown Rice', 'Bell Peppers', 'Garlic & Herbs'],
    ingredientsZh: ['新鲜杏鲍菇', '天然香菇', '白玉菇', '有机原粒糙米', '甜彩椒', '大蒜与香草'],
    prepMethod: 'Light Garlic Olive Oil Sauté',
    prepMethodZh: '蒜香少油温炒',
  }
];

fs.writeFileSync('scripts/generated_items.json', JSON.stringify(itemsConfig, null, 2));
console.log('Saved 24 generated items.');
